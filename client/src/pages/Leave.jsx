...
const Leave = () => {
  ...
  const leaveStats = [
    {label : "Sick Leaves",value :sickCount,icon: Thermometer},

    {label : "Casual Leaves",value :casualCount,icon: Umbrella},

    {label : "Annual Leaves",value :annualCount,icon: Palmtree},
