...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col item-center justify-center p-6 sm:p-12 lg;p-16 relative overflow-y-auto min-h-screen">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="space-y-4">
          {portalOptions.map((portal)=>(
           ...
           <Link key={portal.to} to={portal.to} className="group block bg-slate-50 border-slate-200 rounded-lg p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50">
           <div className="relative z-10 flex item-center justify-between gap-4 sm:gap-5">
        ...
        {/*Footer*/}
            ...
            <div className="mt-12 text-center md:text-left text-sm text-slate-400">
              <p>© {new Date().getFullYear()}Private Limited. All rights reserved.</p>
            </div>
