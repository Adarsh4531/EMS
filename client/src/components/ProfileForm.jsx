    ...
    <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
      ...
      <div className='space-y-5'>
        ...
        <div>
           ...
           <textarea disabled={initialData.isDeleted} name="bio" defaultValue={initialData.bio || ''} placeholder='Write a brief bio...' className={`resize-none ${initialData.isDeleted ? "bg-slate-50 text-slatr-400 cursor-not-allowed" : ""}`} />
        ...
        {initialData.isDeleted ? (
          <div className='pt-2'>
            <div className='p-4 bg-rose-50 border border-rose-200 rounded-xl text-center'>
              ...
              <p className='text-sm text-rose-500 mt-o.5'>You can no longer update</p>
            </div>
          </div>
        ) : (
