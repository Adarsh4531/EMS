  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm' onClick={onClose}>
      ...
      <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in' onClick={(e)=>e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className='p-6 space-y-0.5'>
          {/* leave type  */}

          <div>
            <label className='flex items-centergap-2 text-sm font-medium text-slate-700 mb-2'>
          ...
          <div>
            ...
            <textarea name="reason" required rows={3} className='resize-none' placeholder='Reason for leave...' />
          </div>
          ...
          <div className='flex gap-3 pt-2'>
            ...
            <button type='button' onClick={onClose} className='btn-secondary flex-1'>
             ...
             <button type='submit' disabled={loading}  onClick={onClose} className='btn-primary flex-1 flex items-center justify-center gap-2'>
